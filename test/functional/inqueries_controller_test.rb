...
class InqueriesControllerTest < ActionController::TestCase
  ...
  test "should create inquery" do
    assert_difference('Inquery.count') do
      post :create, inquery: { client: @inquery.client, contact: @inquery.contact, memo: @inquery.memo, receptiondate: @inquery.receptiondate }
    end
  ...
  test "should update inquery" do
    put :update, id: @inquery, inquery: { client: @inquery.client, contact: @inquery.contact, memo: @inquery.memo, receptiondate: @inquery.receptiondate }
    assert_redirected_to inquery_path(assigns(:inquery))
  end
