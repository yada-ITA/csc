...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { client: @inquiry.client, contact: @inquiry.contact, memo: @inquiry.memo, receeptiondate: @inquiry.receeptiondate }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { client: @inquiry.client, contact: @inquiry.contact, memo: @inquiry.memo, receeptiondate: @inquiry.receeptiondate }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
